 ...
 *  LSD radix sort
 *
 *    - SearchAndSort a String[] array of n extended ASCII strings (R = 256), each of length w.
 *
 *    - SearchAndSort an int[] array of n 32-bit integers, treating each integer as
